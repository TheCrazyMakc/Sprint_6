...
class BasePage:
    ...
    # Распаковывает кортеж (By.XPATH, "//div[@id='accordion__heading-{0}']") на две 
    # переменные: method = By.XPATH, locator = "//div[@id='accordion__heading-{0}']".
    # Подставляет число вместо {0}: locator.format(num).
    # Возвращает новый кортеж (By.XPATH, "//div[@id='accordion__heading-3']") — готовый локатор для Selenium.
    @staticmethod
